 ...
 */
public final class YunRect implements Parcelable {
    public int left;
    public int top;
    public int right;
    public int bottom;
     ...
     */
    public YunRect(int left, int top, int right, int bottom) {
        this.left = left;
        this.top = top;
        this.right = right;
        this.bottom = bottom;
     ...
     * @param yun 韵母字符串
     */
    public void setYun(@Nullable String yun) {
        this.yun = yun;
    }
     ...
     */
    public static YunRect unflattenFromString(String str) {
        Matcher matcher = UnflattenHelper.getMatcher(str);
        if (!matcher.matches()) {
            return null;
        }
        return new YunRect(Integer.parseInt(matcher.group(1)),
    ...
    */
    ...
    /**
     * ditto
     * @param p The point in form of {@link android.graphics.PointF}
     * @return true iff (x,y) are contained by the rectangle, where containment
     *              means left <= x < right and top <= y < bottom
     */
     ...
     *              rectangle
     */
    public boolean contains(YunRect r) {
        // check for empty first
        return this.left < this.right && this.top < this.bottom
                // now check for containment
     ...
     * intersection, use {@link #intersects(YunRect, YunRect)}.
     *
     ...
     *              return false and do not change this rectangle.
     */
    public boolean intersect(YunRect r) {
     ...
     */
    public boolean setIntersect(YunRect a, YunRect b) {
     ...
     * use {@link #intersect(YunRect)} or {@link #setIntersect(YunRect, YunRect)}.
     *
     ...
     */
    public static boolean intersects(YunRect a, YunRect b) {
    ...
    public static final Parcelable.Creator<YunRect> CREATOR = new Parcelable.Creator<YunRect>() {
        /**
         * Return a new rectangle from the data in the specified parcel.
         */
        public YunRect createFromParcel(Parcel in) {
            YunRect r = new YunRect();
            r.readFromParcel(in);
            return r;
        }
         ...
         */
        public YunRect[] newArray(int size) {
            return new YunRect[size];
        }
    };
